...
public class FallingObject : MonoBehaviour
{
    ...
    private float leftLimit = -3.19f, rightLimit = 3.1f, minTime = 15.0f, maxTime = 25.0f, timer, timeNextObject;
    ...
    void Update()
    {
        ...
        if (timer >= timeNextObject) {
            ...
            this.transform.position = new Vector3(Random.Range(leftLimit, rightLimit), this.transform.position.y, this.transform.position.z);
